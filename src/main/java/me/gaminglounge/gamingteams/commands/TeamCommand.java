		...
		new CommandAPICommand("GamingTeams:team")
				...
				.withSubcommand(
						new CommandAPICommand(Gamingteams.CONFIG.getString("Commands.Team.SubCommands.add"))
								.withArguments(new StringArgument(
										Gamingteams.CONFIG.getString("Commands.Team.Arguments.name")))
								.withArguments(
										new StringArgument(Gamingteams.CONFIG.getString("Commands.Team.Arguments.tag")))
								.executesPlayer((p, args) -> {
									...
									String name = (String) args
											.get(Gamingteams.CONFIG.getString("Commands.Team.Arguments.name"));

									if (DataBasePool.getTeam(Gamingteams.INSTANCE.basePool, name) != 0) {
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "teamNameInUse", true)));
										return;
									}
									team = DataBasePool.addTeam(
											...
											name,
											(String) args
													.get(Gamingteams.CONFIG.getString("Commands.Team.Arguments.tag")));
									...
									p.sendMessage(
											mm.deserialize(Language.getValue(Gamingteams.INSTANCE, p, "addTeam", true),
								...
								.executesPlayer((p, args) -> {
									...
									if (DataBasePool.isOwner(
										...
										DataBasePool.removePlayerToTeam(
												...
												pID);
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "removedTeam", true)));
										return;
									}
									p.sendMessage(mm
											.deserialize(Language.getValue(Gamingteams.INSTANCE, p, "notOwner", true)));
								}))
				.withSubcommand(
						new CommandAPICommand(Gamingteams.CONFIG.getString("Commands.Team.SubCommands.name"))
								...
								.executesPlayer((p, args) -> {
									...
									if (DataBasePool.isOwner(Gamingteams.INSTANCE.basePool, uuid, team)) {
										DataBasePool.setName(
												Gamingteams.INSTANCE.basePool,
												name,
												uuid);
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "changeName", true),
												Placeholder.component("name", mm.deserialize(name))));
										return;
									}
									p.sendMessage(mm
								...
								.executesPlayer((p, args) -> {
									...
									if (DataBasePool.isOwner(Gamingteams.INSTANCE.basePool, uuid, team)) {
										DataBasePool.setTag(
												...
												p.getUniqueId());
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "changeTag", true),
				...
				.withSubcommand(
						new CommandAPICommand(Gamingteams.CONFIG.getString("Commands.Team.SubCommands.owner"))
								...
								.executesPlayer((p, args) -> {
									OfflinePlayer owner = (OfflinePlayer) args
											.get(Gamingteams.CONFIG.getString("Commands.Team.Arguments.player"));
									...
									if (DataBasePool.isOwner(Gamingteams.INSTANCE.basePool, uuid, team)) {
										...
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "changeOwner", true),
				...
				.withSubcommand(
						new CommandAPICommand(Gamingteams.CONFIG.getString("Commands.Team.SubCommands.leave"))
								.executesPlayer((p, args) -> {
									...
									if (id == 0) {
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "notInATeam", true)));
										return;
									}
									...
									if (DataBasePool.isOwner(
											...
											id)) {
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "ownerCannotLeave", true)));
										return;
									}
						...
						new CommandAPICommand(Gamingteams.CONFIG.getString("Commands.Team.SubCommands.join"))
								...
								.executesPlayer((p, args) -> {
									...
									if (Gamingteams.INSTANCE.manager.accept(p, id)) {
										...
										p.sendMessage(mm.deserialize(
												Language.getValue(Gamingteams.INSTANCE, p, "noInvite", true)));
									}
				...
				.withSubcommand(
						new CommandAPICommand(Gamingteams.CONFIG.getString("Commands.Team.SubCommands.member"))
								...
								.withSubcommand(
										new CommandAPICommand(
												Gamingteams.CONFIG.getString("Commands.Team.SubCommands.info"))
												.executesPlayer((p, args) -> {
													int id = DataBasePool.getTeam(Gamingteams.INSTANCE.basePool,
															p.getUniqueId());
													String name = DataBasePool.getName(Gamingteams.INSTANCE.basePool,
															id);
													String tag = DataBasePool.getTag(Gamingteams.INSTANCE.basePool, id);
													OfflinePlayer owner = DataBasePool
															.getOwner(Gamingteams.INSTANCE.basePool, id);

													p.sendMessage(mm.deserialize(
															Language.getValue(Gamingteams.INSTANCE, p, "info.name",
																	true),
															Placeholder.component("name", mm.deserialize(name))));
													p.sendMessage(mm.deserialize(
															Language.getValue(Gamingteams.INSTANCE, p, "info.tag",
																	true),
															Placeholder.component("tag", mm.deserialize(tag))));
													p.sendMessage(mm.deserialize(
															Language.getValue(Gamingteams.INSTANCE, p, "info.owner",
																	true),
															Placeholder.component("owner",
																	mm.deserialize(owner.getName()))));
